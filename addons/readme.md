...
- [**libconio**](libconio/): A CONsole Input Output system
- [**libkmg**](libkmg/): A handler for the KOS image format
...
- [**libkosh**](libkosh/): A basic KOS shell
...
- [**libpthread**](libpthread/): An implementation of POSIX threads
