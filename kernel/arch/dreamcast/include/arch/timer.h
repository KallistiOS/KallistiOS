...
/** \brief  Start a timer.
    ...
    \param  which           The timer to start (i.e, \ref TIMER_UNIT_0).
    \retval 0               On success.
*/
...
/** \brief  Stop a timer.
    ...
    \param  which           The timer to stop (i.e, \ref TIMER_UNIT_0).
    \retval 0               On success.
*/
...
/** \brief  Obtain the count of a timer.
    ...
    \param  which           The timer to inspect (i.e, \ref TIMER_UNIT_0).
...
/** \brief  Spin-loop sleep function.
    ...
    and interrupts are disabled. It uses \ref TIMER_UNIT_1 to sleep.
...
/** \brief  Enable high-priority timer interrupts.
    ...
    \param  which           The timer to enable interrupts on (i.e, \ref TIMER_UNIT_0).
*/
...
/** \brief  Disable timer interrupts.
    ...
    \param  which           The timer to disable interrupts on (i.e, \ref TIMER_UNIT_0).
*/
...
/** \brief  Enable the millisecond timer.
    ...
    by default. These functions use \ref TIMER_UNIT_2 to do their work.
*/
...
/** \brief  Disable the millisecond timer.
    ...
    \ref TIMER_UNIT_2 for something else.
*/
