...
/** \brief   Perform a DMA transfer to the PVR RAM over 64-bit TA bus.
    ...
    \param  bytes           The number of bytes to copy. Must be a multiple of
                            32.
...
/** \brief   Load a texture using TA DMA.
    ...
    \em     EIO - I/O error
*/
int pvr_txr_load_dma(const void *src, pvr_ptr_t dest, size_t bytes,
                     bool block, pvr_dma_callback_t callback, void *cbdata);
...
/** \brief   Load vertex data to the TA using TA DMA.
    ...
    \em     EIO - I/O error
 */
int pvr_dma_load_ta(const void *src, size_t bytes, bool block,
                    pvr_dma_callback_t callback, void *cbdata);
...
/** \brief   Load yuv data to the YUV converter using TA DMA.
    ...
    \em     EIO - I/O error
*/
int pvr_dma_yuv_conv(const void *src, size_t bytes, bool block,
                     pvr_dma_callback_t callback, void *cbdata);
...
/** \brief   Copy a block of memory to VRAM
    ...
    \param  bytes           The number of bytes to copy (multiple of 32).
...
/** \brief   Set a block of PVR memory to a 16-bit value.
    ...
    \param  bytes           The number of bytes to set (multiple of 32).
    \param  type            The type of SQ/DMA transfer to do (see list of modes).
    \return                 The original value of dest.
