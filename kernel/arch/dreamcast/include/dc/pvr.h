...
typedef struct pvr_stats {
    ...
    int     frame_last_time;     /**< \brief Ready-to-Ready length for the last frame in nanoseconds */
    float   frame_rate;          /**< \brief Current frame rate (per second) */
    int     reg_last_time;       /**< \brief Registration time for the last frame in nanoseconds */
    int     rnd_last_time;       /**< \brief Rendering time for the last frame in nanoseconds */
    ...
    int     buf_last_time;       /**< \brief DMA buffer file time for the last frame in nanoseconds */
