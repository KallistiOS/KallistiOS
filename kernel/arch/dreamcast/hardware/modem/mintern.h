...
#define MODEM_INTERNAL_FLAG_TIMER_HANDLER_SET 0x4 /* The interrupt handler for TIMER_UNIT_1 has been set */
#define MODEM_INTERNAL_FLAG_TIMER_RUNNING     0x8 /* TIMER_UNIT_1 is running */
