...
void pvr_int_handler(uint32_t code, void *data) {
    ...
    switch (code) {
        ...
        case ASIC_EVT_PVR_OPB_OUTOFMEM:
            ...
            dbglog(DBG_SOURCE(PVR_RENDER_DBG), "pvr_irq: PVR_TA_OPB_START: %08lx\n",
                PVR_GET(PVR_TA_OPB_START));
            dbglog(DBG_SOURCE(PVR_RENDER_DBG), "pvr_irq: PVR_TA_OPB_END: %08lx\n",
                PVR_GET(PVR_TA_OPB_END));
            dbglog(DBG_SOURCE(PVR_RENDER_DBG), "pvr_irq: PVR_TA_OPB_POS: %08lx\n",
