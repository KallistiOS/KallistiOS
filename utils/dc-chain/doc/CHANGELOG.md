...
| 2024-04-29 | Donald Haase, Eric Fradella | Patch Newlib headers to expose lstat() declaration. |
...
| 2023-12-23 | Falco Girgis, Eric Fradella | Add multibyte character support as an option for Newlib. |
...
| 2023-09-15 | Falco Girgis, Colton Pawielski | Modify build scripts to enable TLS support |
...
| 2023-06-05 | Eric Fradella, Colton Pawielski | Fix patch.mk to add fetch dependency to sh4-fixup, fixing parallel building. |
| 2023-06-04 | Eric Fradella, Colton Pawielski | Remove fake-kos, gthr-kos, and crt1 from GCC patches and copy them over from file tree instead, reducing labor to generate GCC patches. |
...
| 2023-05-22 | Falco Girgis, Andrew Apperley, Eric Fradella | Update patches to fix libobjc Makefile so that library and headers are properly installed with GCC. |
...
| 2016-07-01 | Corbin, Nia, Lawrence Sebald | Update GDB to 7.11.1 and insight to 6.8 due to previous versions being removed. Add more files to be cleaned up related to GDB/insight in the make clean target. |
...
| 2010-08-21 | Cyle Terry, Lawrence Sebald | Add init fini patch to Newlib. |
...
| 2008-02-16 | Sam Steele, Christian Henz | Add support for building GDB and insight. |
| 2007-07-18 | Atani | Update Binutils to 2.17 to fix GCC 4.x compilation. |
| 2007-07-18 | Atani | Update default paths. |
| 2006-11-24 | Megan Potter, Christian Henz | Fix commented out paths in dc-chain. |
